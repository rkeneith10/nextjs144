    ...
    >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 ">
        <div className="flex flex-col p-4 h-800 bg-white hover:bg-gray-700 hover:text-white transition-transform transform hover:-translate-x-1 rounded-ms shadow-lg">
          ...
          <h1 className="font-bold text-xl">Web Development</h1> <br />
        ...
        <div className="flex flex-col p-4 h-800 bg-white hover:bg-gray-700 hover:text-white transition-transform transform hover:-translate-x-1 rounded-ms shadow-lg">
          ...
          <h1 className="font-bold text-xl">App Development</h1> <br />
        ...
        <div className="flex flex-col p-4 h-800 bg-white hover:bg-gray-700 hover:text-white transition-transform transform hover:-translate-x-1 rounded-ms shadow-lg">
          ...
          <h1 className="font-bold text-xl">Reponsive Design</h1>
