...
const projects = [
  {
    ...
    description:
      "A modern food delivery platform that allows users to browse menus, place online orders, and track deliveries in real time. Built with Next.js and integrated with a secure API for order management.",
