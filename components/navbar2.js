...
export default function navbar2() {
  ...
  return (
    <header className={`${ header ? "bg-gray-800 fixed w-[100%] z-10 text-white" : "bg-[transparent] text-gray-900"}   w-full ease-in duration-300 `}>
        <nav className='max-w-[1366px] h-[100px] flex justify-between p-4 items-center'>
            ...
            <ul className='hidden md:flex uppercase font-semibold text-1xl '>
                <li className='mr-4 lg:mr-8'>
                    <Link to="top"  smooth={true} offset={-180} duration={500}>home</Link>
                </li>
                <li className='mr-4 lg:mr-8'>
                    <Link to="about"  smooth={true} offset={-180} duration={500}>about</Link>
                </li>
                <li className='mr-4 lg:mr-8'>
                    <Link to="services"  smooth={true} offset={-150} duration={500}>services</Link>
                </li>
                <li className='mr-4 lg:mr-8'>
                ...
                <li className='mr-4 lg:mr-8'>
                    <Link to="contact"  smooth={true} offset={-200} duration={500}>contact</Link>
                </li>
            </ul>
             ...
             'md:hidden absolute top-[100px] right-0 bottom-0 left-[-100%] flex justify-center text-center items-center w-full h-screen bg-gray-900 text-white ease-in duration-300'
                ...
                <div className='w-full'>
                    <ul className='uppercase font-bold text-2xl '>
                        <li onClick={handleSmalleNavigation} className='py-5 cursor-pointer'>
                        <Link to="top"  smooth={true} offset={-200} duration={500}>home</Link>
                        </li>
